'''
整体的思路：
1、构造任务队列page_queue ，存放所有要爬取的页面url
...
class ParserThread(threading.Thread):
    """解析网页的类（2），就是对采集结果进行解析，也是多线程方式进行解析"""
        ...
        try:
            ...
            for site in result:
                try:
                    ...
                    print('parse_data错误: ', e)

        except Exception as e:
            print('parse_data外部错误: ', e)
...
def main():
    ...
    # 等待队列情况，先进行网页的抓取
    while not page_queue.empty():   # 判断是否为空
        pass    # 不为空，则继续阻塞
