    ...
    def get_video_urls(self, user_id):
        ...
        while unique_id != user_id:
            search_url = 'https://api.amemv.com/aweme/v1/discover/search/?cursor=0&keyword=%s&count=10&type=1' \
                         ...
                         '&aid=1128&app_name=aweme&version_code=162&version_name=1.6.2&device_platform=android' \
                         '&ssmix=a&device_type=MI+5&device_brand=Xiaomi&os_api=24&os_version=7.0' \
                         '&uuid=861945034132187&openudid=dc451556fc0eeadb&manifest_version_code=162' \
                         '&resolution=1080*1920&dpi=480&update_version_code=1622' % user_id  # keyword=%s
